    ...
    theme: {
        ...
        extend: {
            ...
            keyframes: {
                ...
                'pulse-glow': {
                    '0%, 100%': { boxShadow: '0 0 20px oklch(var(--accent) / 0.1)' },
                    '50%': { boxShadow: '0 0 30px oklch(var(--accent) / 0.2)' }
                },
                'mouse-scroll': {
                    '0%': { 
                        opacity: '0.3', 
                        transform: 'translateY(0)',
                        filter: 'drop-shadow(0 0 2px oklch(var(--accent) / 0.3))'
                    },
                    '50%': { 
                        opacity: '1', 
                        transform: 'translateY(6px)',
                        filter: 'drop-shadow(0 0 8px oklch(var(--accent) / 0.8)) drop-shadow(0 0 12px oklch(var(--accent) / 0.4))'
                    },
                    '100%': { 
                        opacity: '0.3', 
                        transform: 'translateY(0)',
            ...
            animation: {
                ...
                'mouse-scroll': 'mouse-scroll 2s ease-in-out infinite',
                'name-fade-in': 'name-fade-in 1.2s cubic-bezier(0.22, 0.61, 0.36, 1) forwards'
            }
        }
    },
